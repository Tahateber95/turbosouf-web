  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className="w-full h-10 px-3 rounded-lg bg-white/10 border border-white/20 text-sm text-left flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-[#FF7A45]/50 focus:border-[#FF7A45]/60 gap-2 transition-colors"
      >
