  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className="w-full h-10 px-3 rounded-lg bg-white border border-gray-200 text-sm text-left flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30 focus:border-[#E85D26] gap-2 transition-colors"
      >
