import { Store, Truck, CreditCard, Users, Database, Mail } from "lucide-react";

const SETTINGS_SECTIONS = [
  { icon: Store, label: "Informations boutique", desc: "Nom, adresse, SIRET, coordonnées", href: "#" },
  { icon: Truck, label: "Livraison", desc: "Méthodes de livraison et tarifs", href: "#" },
  { icon: CreditCard, label: "Paiement", desc: "Configuration Stripe, PayPal, Alma", href: "#" },
  { icon: Database, label: "Sage", desc: "Connexion et paramètres de synchronisation", href: "#" },
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {SETTINGS_SECTIONS.map((section) => (
          <div key={section.label} className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md hover:border-gray-200 transition-all cursor-pointer group">
